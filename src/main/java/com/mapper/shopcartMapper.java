...
public interface shopcartMapper {
    ...
    int updateBycomId(@Param("commId")int commId,@Param("commNum")Integer commNum);
    
    shopcart selectByLock(@Param("commId")Integer commId);
    
    ArrayList<shopcart> selectBystatus(@Param("status")Integer status);
    
    int updateCanel(@Param("status")Integer status,@Param("id")Integer id,@Param("date")Date date);
